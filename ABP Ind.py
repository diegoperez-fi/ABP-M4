...
# Clase ClientePremium (hereda de Cliente)
class ClientePremium(Cliente):
    def __init__(self, id, nombre, apellido, fecha_registro, saldo, contacto=None):
        super().__init__(id, nombre, apellido, fecha_registro, saldo, contacto)
        self.descuento = 0.1  # Descuento del 10% para clientes premium

    # Método para aplicar descuento al saldo
    def aplicar_descuento(self):
        descuento = self.obtener_saldo() * self.descuento
        self.actualizar_saldo(-descuento)





# Clase ClienteRegular (hereda de Cliente)
class ClienteRegular(Cliente):
    def __init__(self, id, nombre, apellido, fecha_registro, saldo, contacto=None):
        super().__init__(id, nombre, apellido, fecha_registro, saldo, contacto)
        self.tarifa = 0.05  # Tarifa adicional del 5% para clientes regulares

    # Método para aplicar tarifa adicional al saldo
    def aplicar_tarifa(self):
        tarifa = self.obtener_saldo() * self.tarifa
        self.actualizar_saldo(tarifa)
...
# Clase ClienteNuevo (hereda de Cliente)
class ClienteNuevo(Cliente):
    def __init__(self, id, nombre, apellido, fecha_registro, saldo, contacto=None):
        super().__init__(id, nombre, apellido, fecha_registro, saldo, contacto)
        self.bonificacion = 50  # Bonificación de $50 para nuevos clientes

    # Método para aplicar bonificación al saldo
    def aplicar_bonificacion(self):
        self.actualizar_saldo(self.bonificacion)
...
# Instancias de herencias de clientes
cliente_premium = ClientePremium(1, "Daniel", "Cordero", "01-01-2023", 1000)
cliente_premium.mostrar_saldo()  # Tu saldo actual es de: 1000

cliente_premium.aplicar_descuento()
cliente_premium.mostrar_saldo()  # Tu saldo actual es de: 900

cliente_regular = ClienteRegular(2, "Cristobal", "Figueroa", "01-01-2022", 2000)
cliente_regular.mostrar_saldo()  #  Tu saldo actual es de: 2000

cliente_regular.aplicar_tarifa()
cliente_regular.mostrar_saldo()  # Tu saldo actual es de: 2100

cliente_nuevo = ClienteNuevo(3, "Elias", "Villanueva", "01-05-2023", 500)
cliente_nuevo.mostrar_saldo()  # Tu saldo actual es de: 500

cliente_nuevo.aplicar_bonificacion()
cliente_nuevo.mostrar_saldo()  #  Tu saldo actual es de: 550
